...
class Monster(animation.AnimateSprite):
    ...
    def damage(self, amount):
        ...
        #verifier si son nouveau nombre de points de vie est inférieur à 0
        if self.health <= 0:
            ...
            # si la barre d'évènements est chargé à son maximum
    ...
    def forward(self):
        #le déplacement ne se fait que si il n'y a pas e collision avec un groupe de joueur
