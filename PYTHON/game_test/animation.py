...
# definir une classe qui va s'ocuuper des animations
class AnimateSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_name, size=(200, 200)):
        ...
        self.current_image = 0 #commencer l'animation à l'image
    ...
    def animate(self, loop=False):
        ...
        if self.animation:
            ...
            #verifier si on a atteint la fin de l'aniation
...
def load_animation_images(sprite_name):
    #Charger les 24 images de ce sprite dans le dossier correspondants
    images = []
