...
# creer une seconde classe qui va reprsenter notre jeu
class Game:
    ...
    def __init__(self):
        ...
        # gerer le son
        self.sound_manager = SoundsManager()
        #mettre le score à 0
    ...
    def update(self, screen):
        ...
        #actualiser l'animaion du joueur
        self.player.update_animation()

        # recupérer les projectiles du joueur
        for projectille in self.player.all_projectile:
            projectille.move()
        ...
        #recuper les cometes de notre jeu
