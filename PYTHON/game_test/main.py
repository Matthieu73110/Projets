...
#importer de chrger l'arriere plan de notre jeu
...
while running :
    ...
    if game.is_playing:
        #déclencher les instructons de la partie
        game.update(screen)
    ...
    for event in pygame.event.get():
        # que l'événement est fereture de fenetre
        if event.type == pygame.QUIT:
            running = False
            pygame.quit()
        #detecter si un jouer lache une touche du clavier
            ...
            # verfifiction pour savoir si la souris est en collision avec le bouton jouer
